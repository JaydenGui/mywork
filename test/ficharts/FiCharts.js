(function(){
	...
	win.Polygon3D = Polygon3D;
	Polygon3D.swfURL = "Polygon3D.swf";
	Polygon3D.prototype = function() {
		
		var that = chartBase();
		that.constructor = function(arg) {
			init(this, arg);
			this.swfURL = getSWFURL(Polygon3D.swfURL);
		};
