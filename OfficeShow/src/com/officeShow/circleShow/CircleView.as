package com.officeShow.circleShow
{
	...
	public class CircleView extends Sprite
	{
		...
		private var texts:Array = ["品牌","评价","覆盖"];
		...
		private var tooltipSprite:TooltipSprite;
		private var tooltipText:String = "";
		private var tooltipOffsetX:int = 10;
		private var tooltipOffsetY:int = 10;
		...
		private function rollOverHandler(e:MouseEvent):void
		{
			...
			tooltipSprite.data = "品牌 / 评价 / 覆盖 = "+tooltipText;
			tooltipSprite.x = e.stageX + tooltipOffsetX;
			tooltipSprite.y = e.stageY + tooltipOffsetY;
			if(this.stage)
				this.stage.addChild(tooltipSprite);
		}
		...
		private function rollOutHandler(e:MouseEvent):void
		{
			...
			if(tooltipSprite && stage)
				this.stage.removeChild(tooltipSprite);
		}
