...
//			var txt:String = '{"brand":[{"name":"宝马","logo_url":"1","inner":[25,50,75],"position":[35,66]}, {"name":"宝马","inner":[25,50,75],"position":[35,66]}]';
			var txt2:String = '{"cate":"汽车","brand":[{"radius":60,"color":0,"inner":[25,50,65],"position":[135,166],"name":"宝马","logo-url":"../res/奥迪.png"},{"radius":80,"color":1,"inner":[25,50,75],"position":[166,135],"name":"宝马","logo-url":"../res/宝马.png"}]}';
			var t:Object = {brand:[{"name":"宝马","logo-url":"../res/奥迪.png","inner":[25,50,65],"position":[135,166]},{"name":"宝马","logo-url":"../res/宝马.png","inner":[25,50,75],"position":[166,135]}]};
