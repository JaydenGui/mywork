package com.officeShow.circleShow
{
	...
	public class FanView extends Sprite
	{
		public function FanView()
		{
			super();
		}
		
		public function  drawSector(x:Number=200,y:Number=200,r:Number=100,angle:Number=27,startFrom:Number=270,color:Number=0xff0000):void {
